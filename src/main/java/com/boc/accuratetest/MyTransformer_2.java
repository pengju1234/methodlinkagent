...
public class MyTransformer_2 implements ClassFileTransformer {
    ...
    public MyTransformer_2(Map<String,String> argsMap) {
    	this.argsMap = argsMap;
	}
    public MyTransformer_2() {
	}
    public byte[] transform(ClassLoader loader, String className, Class<?> classBeingRedefined,
        ...
        try {
            ...
            CtClass old = null;
    		try {
    			old = classPool.get("com.boc.Link1234");
    		} catch (NotFoundException e) {
    			CtClass link1234 = classPool.makeClass("com.boc.Link1234");
    			
    			//添加构造函数
    			CtConstructor ctConstructor = new CtConstructor(new CtClass[]{}, link1234);
    			//为构造函数设置函数体
    			...
    			//把构造函数添加到新的类中
    			link1234.addConstructor(ctConstructor);
    			
    			//添加自定义方法
    			CtMethod ctMethod = new CtMethod(CtClass.voidType,"printStackTrace",new CtClass[]{},link1234);
    			//为自定义方法设置修饰符
    			ctMethod.setModifiers(Modifier.PUBLIC);
    			//为自定义方法设置函数体
    			ctMethod.setBody("{"+insertMethod("", "", "")+"}");
    			link1234.addMethod(ctMethod);
    			return link1234.toBytecode(); // 每一个class都会进入transform方法，大概这样创建类会覆盖原来的class
    		}
	...
	public static String insertMethod(String classname,String methodName,String params) {
		return  "com.boc.Link1234 link1234 = new com.boc.Link1234();\r\n" + 
				"link1234.printStackTrace();";
	}
	/**
	 * 	the chazhuang method
	 * @param classname
	 ...
	 * @return
	 */
	public static String insertMethod_old(String classname,String methodName,String params) {
	...
	public static String insertMethod_currentParams(String classname,String methodName,String params) {
		return  "java.io.FileWriter fw1234 = null;\r\n" + 
				...
				"	        			fw1234.write(className1234+\".\"+methodName1234+\"("+params+")\");\r\n" + 
				"	        		}else {\r\n" + 
				"	        			fw1234.write(className1234+\".\"+methodName1234);\r\n" + 
				"	        		}\r\n" + 
				"	    			fw1234.write(\"\\r\\n\");\r\n" + 
				"	    			fw1234.flush();\r\n" + 
				"	        	}else {\r\n" + 
